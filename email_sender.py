...
<tr><td style="padding:40px;">
  ...
  <div style="background:#1a1a2e;border-radius:8px;padding:16px 20px;margin:0 0 24px;overflow-x:auto;">
    <pre style="margin:0;color:#e0e0e0;font-family:'JetBrains Mono',Consolas,monospace;font-size:12px;line-height:1.6;white-space:pre-wrap;">curl -X POST https://api.harrisoncollab.com/v1/health-check \\
  ...
  <p style="margin:0 0 8px;color:#4A5568;font-size:14px;">
    <strong>API Docs:</strong> <a href="https://api.harrisoncollab.com/docs" style="color:#7C9A6E;">Interactive API Explorer</a>
  </p>
  <p style="margin:0;color:#4A5568;font-size:14px;">
...
def _drip_email_3_html(api_key: str, calls_made: int) -> str:
    ...
    links to upgrade and Telegram channel.
    """
